...
namespace PokerBot
{
    ...
    public static class Poker
    {
        ...
        private static Dictionary<int[],Hand> _scoreTable = new Dictionary<int[],Hand>();
        ...
        private static int getScore(int[] ranks, long solo, long allCards, long suits)
        {
        ...
        public static Hand ParseAsHand(List<KeyValuePair<int, int>> cards)
        {
           ...
           return new Hand(){ Score = getScore(ranks, solo, allCards, suits), TieBreaker = getTieBreaker(allCards) };
